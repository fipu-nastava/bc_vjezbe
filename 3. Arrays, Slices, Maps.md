...
2. Kreiraj niz od 10 brojeva koje je korisnik upisao. Napravi funkciju koja vraća sumu brojeva u nizu. Pozovi funkciju i ispiši sumu.

3. Kreiraj program koji će izgenerirati nasumičan broj nasumičnih cijelih brojeva. Potrebno je te brojeve spremiti u niz, a zatim izbaciti duplikate ukoliko ih ima. Na kraju je potrebno ispisati sortiran niz.

4. Ispiši dnevne zahtjeve web servera
...
5. Kreiraj program koji vraća studente u određenoj sobi fakultetskog doma
...
6. Ispiši sve ključ-vrijednost elemente koji se podudaraju u sljedećim mapama
...
7. Kreiraj program koji će pobrojati broj ponavljanja pojedine riječi u nekom tekstu. Program mora pohraniti broj ponavljanja u mapu (riječi su ključevi, broj ponavljanja su vrijednosti). Tekst se može spremiti u varijablu direktno u neku varijablu, a može se preuzeti s npr. Lorem Ipsum stranice.

8. Kreiraj mapu koja koristi stringove kao ključeve te sliceve integera kao vrijednosti. Mapa sadrži gradove te očitane temperature po svakom gradu za jedan tjedan. Program mora ispisati prosječnu temperaturu za **Pulu**.
